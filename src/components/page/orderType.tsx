    ...
    <>
      <PageWrapper>
        <div className="order-type">
          <div className="h1 mb-12 are-you-staying-or-going">
            Are you staying or going?
          </div>
          <div className="images-wrapper">
            <div
              className="mr-12 dine-in-image-wrapper"
              onClick={() => onSelectOrderType(EOrderType.DINEIN)}
            >
              <CachedImage
            ...
            <div
              className="take-away-image-wrapper"
              onClick={() => onSelectOrderType(EOrderType.TAKEAWAY)}
            >
              <CachedImage
