...
export const convertHtmlToBase64 = (url: string, imageWidth: number, mineType: string): Promise<string> => {
    return new Promise(async (resolve, reject) => {
        ...
        const html = `<!DOCTYPE html><html><head><style type="text/css"> body{max-width: 280px; text-align: center;}h1{font-size:24px;}p{font-weight: bold;}img{width: 250px;}</style></head><body><img src="https://d2nmoln0sb0cri.cloudfront.net/protected/ap-southeast-2:de90f0a4-8492-410c-8720-7a494ad92f91/2021-05-17_05:35:58.714-logo3-copy.png"/><h1>My First Heading Heading Heading</h1><p>My first paragraph.</p><div>Order placed: 01 Feb 15:03:55 PM</div><div>Order completed: 01 Feb 15:03:55 PM</div></body></html>`;
