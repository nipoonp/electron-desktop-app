...
namespace ReactAutosuggest {
    ...
    interface InputProps<Suggestion = any> extends Omit<React.HTMLProps<HTMLInputElement>, "value" | "onChange" | "onBlur"> {
        ...
        onBlur?(event: React.FocusEvent<HTMLInputElement>, payload: { highlightedSuggestion: Suggestion | null }): void;
    }

    // React.HTMLProps<HTMLInputElement> with mandatory onChange/value
    interface ControlledInputProps extends Omit<React.HTMLProps<HTMLInputElement>, "value" | "onChange"> {
        value: Value;
...
declare module "react-autosuggest" {
    interface Props<Suggestion, Section> {
        ...
        renderSuggestion(suggestion: Suggestion, payload: { query: string; isHighlighted: boolean }): void;
        ...
        renderInputComponent?(inputProps: ReactAutosuggest.ControlledInputProps): JSX.Element;
    ...
    type Autosuggest<Suggestion = any, Section = void> = React.Component<Props<Suggestion, Section>, {}>;
...
declare module "autosuggest-highlight/parse" {
    const parse: (label: string, matches: ReactAutosuggest.Match[]) => { highlight: boolean; text: string }[];
    export = parse;
}
